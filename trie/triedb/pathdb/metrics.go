...
var (
	...
	nodeBufferLastStateIdGauge         = metrics.NewRegisteredGauge("pathdb/nodebufferlist/laststateid", nil)
	nodeBufferLastDifflayerAvgSize     = metrics.NewRegisteredGauge("pathdb/nodebufferlist/difflayeravgsize", nil)
	...
	withdrawalProofReaderSuccess       = metrics.NewRegisteredMeter("pathdb/nodebufferlist/success", nil)
	withdrawalProofReaderMismatch      = metrics.NewRegisteredMeter("pathdb/nodebufferlist/mismatch", nil)
	withdrawalProofReaderWithoutStop   = metrics.NewRegisteredMeter("pathdb/nodebufferlist/withoutstop", nil)
	withdrawalProofReaderLessDifflayer = metrics.NewRegisteredMeter("pathdb/nodebufferlist/lessdifflayer", nil)
)
